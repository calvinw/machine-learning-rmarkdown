...
You can call the factorial function.  
```{r}
factorial(6)
```

Factorial means you just multiple all integers up to that number together:
...
Now we can check this by raising 10 to that power.
...
Things like this are called "Booleans", and they are important in programming. You can make a program do something when one expression is greater than another, or if two things are equal you can make your program do one thing, but if they are not equal you can make your program do something else. We will see some of this later on...
