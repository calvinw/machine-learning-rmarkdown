...
```{r, eval=F, include=F}
# This code allows to write the data as a markdown table and then test it directly. 
...
#Put your training data frame here
train<-'
'
traindf<-read.md(train, stringsAsFactors=TRUE)
str(traindf)

#Put your testing data frame here
test<-'
'
...
Finally using `mean` we can count the number of times the predictions agreed with the actual: 
