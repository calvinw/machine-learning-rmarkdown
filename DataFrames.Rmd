...
We can use a sequence to get a range of rows or columns. This is the 2nd through 4th rows:
...
This has the same fields (columns) as the original data frame but it excludes some of the rows.
