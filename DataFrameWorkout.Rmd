...
Call the data frame `myDataFrame` and use the `data.frame` function. You will probably need to make some appropriate vectors to be the columns of your dataframe:
