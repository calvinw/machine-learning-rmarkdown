...
Finally lets make a dataframe of our fields. We have to clean up the titles array, since it sometimes has weird unicode in it. (Like Money Bags unicode). We want to have pure text. 
```{r}
