...
- Include graphics that show the scatterplot and also show the regression line on the plot.
- Include the output below as one of your text cells after you run the lm. Fill in the m, b, and ??? to show the standard error and p-values. You must run all the R commands like in the Ice Cream Sales and Sunflower Sales.
